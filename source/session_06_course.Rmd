...
I've written the import script to get you started, which you can download from the [Session 6 materials page](session_06_materials.html), or copy from below.
...
Find patients who were last contacted in 2017 and merge their patient information with their diagnosis records.
Transform all dates to be the number of days since first patient contact.
